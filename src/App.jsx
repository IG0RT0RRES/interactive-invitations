      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-white p-6 font-mono text-left max-w-2xl mx-auto">
        <div className="bg-red-950/80 border-2 border-red-500 p-6 rounded-2xl w-full shadow-2xl">
          ...
          <p className="text-xs text-slate-400 mt-4 leading-relaxed">
            💡 <strong>Dica:</strong> Se o retorno acima mostrar <code>data: null</code>, certifique-se de que a rota no seu <code>App.jsx</code> está configurada como <code>path="/convite/:slug"</code> e que o slug digitado existe na tabela <code>eventos</code> do Supabase.
          </p>
        </div>
      </div>
    );
